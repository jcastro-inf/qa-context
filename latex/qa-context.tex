...
*A contextual modeling recommendation approach based on semantic model with topic discovery in collective interest.\\
*Context aware content based recommendation with semantic model and fuzzy clustering.\\
*Harnessing context based on collaborative interest for improving question recommendation with semantic model.\\
*Collective interest topic detection for improving question recommendation with semantic model.\\
*Extracting context from collective interest to improve recommendation in question answering domain.\\
*A context aware approach based on collective interest for improving question recommendation with semantic-based models.}
