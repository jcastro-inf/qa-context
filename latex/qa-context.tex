...
\title{A question answer-based context-aware recommendation method with semantic model within a Big Data framework \revise{Luis: (add BigData across the paper)}}
...
\noindent The profile does not need to be normalised because it is later compared with other profiles using cosine correlation coefficient, which only considers the angle of the vectors being compared.
