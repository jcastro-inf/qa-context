...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.95\textwidth]{figures/svd-scheme.eps}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.95\textwidth]{figures/mapreduce.eps}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/context-dataset-description.eps}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/ndcg-results-proposal-context-no-clustering.eps}
    \caption{Results managing context without clustering}
    \label{fig:ndcg-results-proposal-context-no-clustering}
\end{figure}
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/ndcg-results-proposal-context-fuzzy-clustering-membership.eps}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/ndcg-results-proposal-context-fuzzy-clustering-max.eps}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/ndcg-results-3proposals-bests-per-day.eps}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/ndcg-results-3proposals-average.eps}
