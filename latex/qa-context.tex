...
\title{Context aware content based recommendation of question answering items with semantic model of question domain and topic detection of collaborative interest of users}

\title{A contextual modeling recommendation approach based on semantic model with topic discovery in collective interest.}

\title{Context aware content based recommendation with semantic model and fuzzy clustering.}

\title{Harnessing collaborative interest context for improving question recommendation with semantic model.}

\title{Collective interest topic detection for improving question recommendation with semantic model.}

\title{Extracting context from collective interest to improve recommendation in question answering domain.}
