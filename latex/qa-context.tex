...
*A contextual modeling recommendation approach based on semantic model with topic discovery in collaborative interest.\\
...
*collaborative interest topic detection for improving question recommendation with semantic model.\\
*Extracting context from collaborative interest to improve recommendation in question answering domain.\\
*A context aware approach based on collaborative interest for improving question recommendation with semantic-based models.\\
*A context-aware recommender system based on collaborative interest for improving question recommendation with semantic-based models.}
